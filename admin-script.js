...
<div style="width: 54mm; height: 86mm; overflow: hidden; break-inside: avoid; background: transparent;">
    ...
    <!-- Logo (Absolutely Positioned above orange wave) -->
    <div style="position: absolute; top: 15px; left: 0; width: 100%; text-align: center; z-index: 20;">
        <img src="logo black academe.png" style="height: 110px; object-fit: contain; margin: 0 auto; display: block;" alt="Logo">
    </div>

    <!-- Content Wrapper -->
    <div style="position: relative; z-index: 10; padding: 125px 20px 0; text-align: center;">
        <!-- Photo -->
        <div style="width: 90px; height: 90px; margin: 0 auto 8px; border-radius: 50%; border: 3px solid #ea580c; padding: 3px; background: #fff; position: relative;">
            <img src="${photoSrc}" style="width: 100%; height: 100%; border-radius: 50%; object-fit: cover;" alt="Student Photo">
        </div>

        <!-- Name -->
        <h2 style="font-size: 18px; font-weight: 900; margin: 0 0 4px; letter-spacing: 0.5px; line-height: 1.1; text-transform: uppercase;">
        ...
        <div style="text-align: left; padding: 0 10px;">
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px; border-bottom: 1px solid #f3f4f6; padding-bottom: 4px;">
                ...
                <div style="font-size: 10.5px; font-weight: 600; color: #374151; width: 85px;">Student ID</div>
                <div style="font-size: 10.5px; font-weight: 800; color: #ea580c;">: &nbsp;${admId}</div>
            </div>
            
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px; border-bottom: 1px solid #f3f4f6; padding-bottom: 4px;">
                <div style="width: 20px; height: 20px; background: #ea580c; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0;">
                    <svg style="width: 11px; height: 11px; color: white;" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg>
                </div>
                <div style="font-size: 10.5px; font-weight: 600; color: #374151; width: 85px;">Date of Birth</div>
                <div style="font-size: 10.5px; font-weight: 700; color: #111827;">: &nbsp;${dob}</div>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px; border-bottom: 1px solid #f3f4f6; padding-bottom: 4px;">
                ...
                <div style="font-size: 10.5px; font-weight: 600; color: #374151; width: 85px;">Parent Mobile</div>
                <div style="font-size: 10.5px; font-weight: 700; color: #111827;">: &nbsp;${phone}</div>
            </div>
            ...
            <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 6px; border-bottom: 1px solid #f3f4f6; padding-bottom: 4px;">
                ...
                <div style="font-size: 10.5px; font-weight: 600; color: #374151; width: 85px;">Blood Group</div>
                <div style="font-size: 10.5px; font-weight: 700; color: #111827;">: &nbsp;${blood}</div>
            </div>
            ...
            <div style="display: flex; align-items: flex-start; gap: 10px;">
                ...
                <div style="font-size: 10.5px; font-weight: 600; color: #374151; width: 85px;">Address</div>
                <div style="font-size: 10.5px; font-weight: 700; color: #111827; flex: 1; line-height: 1.3; overflow: hidden; display: -webkit-box; -webkit-line-clamp: 2; -webkit-box-orient: vertical;">: &nbsp;${addr}</div>
            </div>
        </div>
    </div>
