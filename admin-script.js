...
<div style="width: 54mm; height: 86mm; overflow: hidden; break-inside: avoid; background: transparent;">
    ...
    <div style="position: absolute; top: 22px; left: 0; width: 100%; text-align: center; z-index: 20;">
        <img src="logo black academe.png" style="height: 80px; object-fit: contain; margin: 0 auto; display: block;" alt="Logo">
    </div>

    <!-- Content Wrapper -->
    <div style="position: relative; z-index: 10; padding: 105px 20px 0; text-align: center;">
        <!-- Photo -->
